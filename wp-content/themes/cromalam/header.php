...
<div id="overlay-loader-red" class="overlay-loader" style="background-color: <?php echo get_theme_mod('loader1_color'); ?> !important;">
    <div class="overlay-loader-inner">
        <span class="loader-logo logo" style="background-image: url('<?php echo get_theme_mod('pre_loader_image'); ?>') !important;"></span>
    </div>
</div>
<div id="overlay-loader-grey" class="overlay-loader" style="background-color: <?php echo get_theme_mod('loader2_color'); ?> !important;">
    <div class="overlay-loader-inner">
        <span class="loader-logo logo" style="background-image: url('<?php echo get_theme_mod('pre_loader_image'); ?>') !important;"></span>
    </div>
</div>
            ...
            <div class="site-menu__half screen-height">
                <div class="site-menu__half__inner">
                    ...
                    <div class="site-menu__half__contact">
                        <p>T: <?php echo get_theme_mod('contact_number'); ?></p>
                        <p><a href="#" target="_parent">E: <?php echo get_theme_mod('contact_email'); ?></a></p>
                    </div>
                </div>
            </div>
        ...
        <div id="site-search" class="site-search">
            ...
            <div class="container clearfix">
                <div class="site-search__container">
                    ...
                    </form>                <div class="site-search__key-info">
                        <h4>Key Information</h4>
                        <ul>
                            <li><a href="#" target="_parent">Services</a></li>
                            <li><a href="#" target="_parent">Parkrose</a></li>
        ...
        <div id="site-projects" class="site-projects">
            <div class="site-projects__mouse-area">
                <div class="site-projects__mouse-area__project">
                    <a href="<?php echo site_url(); ?>/inspiration" class="site-projects__mouse-area__view-all">View All</a>
                </div>
                <?php
                    $args = array(
                        'orderby'                  => 'term_id',
                    ...
                    foreach($categories as $category){
                        ...
                        echo '<div class="site-projects__mouse-area__project site-projects__mouse-area__project--'.$count.'"><h3 class="site-projects__mouse-area__project__title">'.$category->name.'</h3><a href="'.$catUrl.'" target="_parent"><img width="204" height="204" src="'.$catImage.'" class="attachment-project_circle size-project_circle wp-post-image" alt="" sizes="(max-width: 204px) 100vw, 204px" /></a></div>';
